...
\midrule
Structure (skeleton) & POS Cosine Similarity & 0.946 \\
...
grammatical structure (POS cosine drops only 5\%).
...
(BERTScore: $-$19\%), and finally syntactic structure (POS: $-$5\%).
...
\begin{enumerate}[leftmargin=*,topsep=2pt,itemsep=1pt]
  \item \textbf{A four-layer decay hierarchy:} lexical surface is
    ...
    syntactic structure (POS cosine: 0.95).
